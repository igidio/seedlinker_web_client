  ...
  en: {
    ...
    logs: {
      ...
      charts: {
        ...
        average_dht_by_day: 'Average DHT by day',
        average_dht_by_device: 'Average DHT by device',
  ...
  es: {
    ...
    logs: {
      ...
      charts: {
        ...
        average_dht_by_day: 'Promedio de DHT por día',
        average_dht_by_device: 'Promedio de DHT por dispositivo',
