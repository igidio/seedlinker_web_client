...
const schema = z
  .object({
    username: z
      .string({ required_error: 'error.input.username.required' })
      .min(3, { message: 'error.input.username.min_length' }),
    email: z
      .string({ required_error: 'error.input.email.required' })
      .email({ message: 'error.input.email.invalid' }),
    password: z
      .string({ required_error: 'error.input.password.required' })
      .min(8, { message: 'error.input.password.min_length' }),
    confirm_password: z
      .string({ required_error: 'error.input.password.required' })
      .min(8, { message: 'error.input.password.min_length' }),
  })
